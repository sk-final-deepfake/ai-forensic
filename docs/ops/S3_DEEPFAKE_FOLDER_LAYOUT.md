...
- [VIDEO_DEEPFAKE_MODEL_BENCHMARK_3x3.md](../deepfake/VIDEO_DEEPFAKE_MODEL_BENCHMARK_3x3.md) — 벤치 RUN_ID (레거시 경로 참조)
- [AI_VISUALIZATION_ARTIFACTS.md](../contracts/AI_VISUALIZATION_ARTIFACTS.md) — 분석 artifact
