...
> **관련 문서:** [VIDEO_DEEPFAKE_MODEL_BENCHMARK_3x3.md](./VIDEO_DEEPFAKE_MODEL_BENCHMARK_3x3.md), [FORENSHIELD_AI_GPU_WORKSTATION.md](../ops/FORENSHIELD_AI_GPU_WORKSTATION.md), [VIDEO_DATASET_INVENTORY.md](./VIDEO_DATASET_INVENTORY.md) (GPU 실측 개수)
