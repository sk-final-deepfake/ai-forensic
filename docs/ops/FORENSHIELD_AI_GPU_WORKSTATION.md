...
| **문서** | [VIDEO_DEEPFAKE_MODEL_BENCHMARK_3x3.md](../deepfake/VIDEO_DEEPFAKE_MODEL_BENCHMARK_3x3.md) | [TAMPERING_DETECTION_PIPELINE.md](../forgery/TAMPERING_DETECTION_PIPELINE.md) · [REGION_THRESHOLD_CALIBRATION.md](../forgery/REGION_THRESHOLD_CALIBRATION.md) |
...
```text
# 1차 벤치 (신규 prefix)
s3://forenshield-evidence-.../deepfake/datasets/bench/...
s3://forenshield-evidence-.../deepfake/results/infer/...
s3://forenshield-evidence-.../deepfake/archive/legacy-benchmarks/...
...
- [TAMPERING_DETECTION_PIPELINE.md](../forgery/TAMPERING_DETECTION_PIPELINE.md) — 2차 파이프라인 설계
- [REGION_THRESHOLD_CALIBRATION.md](../forgery/REGION_THRESHOLD_CALIBRATION.md) — 임계값·region 합성
- [VIDEO_DEEPFAKE_MODEL_BENCHMARK_3x3.md](../deepfake/VIDEO_DEEPFAKE_MODEL_BENCHMARK_3x3.md) — 1차 벤치
